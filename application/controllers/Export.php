...
class Export extends CI_Controller {
    ...
    public function index() {
        $result = [];
        $result_ = [];
        $objPHPExcel = PHPExcel_IOFactory::load('./assets/excel/IAAS29.xlsx');
                ...
                foreach ($query2 as $value2) {
                    ...
                    if ($value2["anwser_status_delete"] == "del") {
                        ...
                        if ($value2["anwser_update_date"] == "") {
                            ...
                            $anwser_update_date = $this->convert_date_b($value2["anwser_respone_date"]);
...
//                $objPHPExcel->getActiveSheet()->setTitle($query[0]["project_name"]);
            ...
            ob_end_clean();
            $namefile = substr($query[0]["project_name"], 0, 2048);
            header('Content-Type: application/vnd.ms-excel');
            header('Content-Disposition: attachment;filename="IA-AS-29 ' . $namefile . '.xlsx"');
