    ...
    <body id="page-top" onload="startTime()">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12">
                                <div class="card shadow mb-4">
                                    ...
                                    <form enctype="multipart/form-data" id="yourForm" novalidate="">
                                        <div class="col-xl-12 col-lg-12">

                                            <!--<img src="<?php echo @$q[0]['filebook_path'] ?>" alt="Smiley face" height="42" width="42">-->

                                            <label for="exampleForm2" class="h5">หัวข้อ</label>
                                            <input type="text" id="topic" class="form-control" name="topic" required="true">
                                        </div>
                                        <div class="col-xl-12 col-lg-12">
                                            <label for="exampleForm2" class="h5">วันที่</label>
                                            <input type="text"  class="datepicker form-control" data-date-format="mm/dd/yyyy" name="date">
                                        </div>
                                        <br>
                                        <div class="col-xl-12 col-lg-12">
                                            <div class="form-group">
                                                <div class="file-loading">
                                                    ...
                                                    <input id="file-3" type="file" multiple name="files[]">
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-primary btn-lg btn-block" onclick="insert()">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            $("#file-3").fileinput({
                ...
                uploadUrl: "<?php echo base_url() ?>/Upload/upload_multi_insert",
...
//                bootbox.alert("This is the default alert!");
                ...
                return !confirm('ต้องการ ลบหรือไม่')
