                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="form-group text-right" style="">
                            <button type="button" class="btn btn-success"
                                onclick="window.location.href = '<?= base_url("index.php/Home/insert_view?project_type=office") ?>'"><i
                                    class="fa fa-paste"></i> เพิ่มโครงการตรวจสอบส่วนกลาง</button>
                            <br>
                            <button type="button" class="btn btn-primary"
                                onclick="window.location.href = '<?= base_url("index.php/Home/insert_view?project_type=station") ?>'"
                                style="margin-top: 0.5em"> <i class="fa fa-bus"></i>
                                เพิ่มโครงการตรวจสอบส่วนภูมิภาค</button>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="datepicker1 form-control form-control-sm"
                                                placeholder="วันที่เรื่มต้น" data-date-format="mm/dd/yyyy"
                                                id="start_date" readonly autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <label for="demo">ถึงวันที่</label>
                                        <div class="input-group mb-3">
                                            <input type="text" class="datepicker2 form-control form-control-sm"
                                                placeholder="วันที่สิ้นสุด" data-date-format="mm/dd/yyyy" id="end_date"
