                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="d-flex flex-row-reverse" >
                                    ...
                                    if ($project_user_process == $_SESSION["user"]["0"]["PER_CODE"]) {
                                        ...
                                        $user = $controller->db->select("*")
                                            ...
                                            ->get()->result_array();
                                        //  echo @$person = '<div class="d-flex flex-row-reverse" id="use" style="    font-size: 0.8em;">ผู้กำลังใช้งาน : ' . $user[0]["FIRST_NAME"] . " " . $user[0]["LAST_NAME"] . '</div>';
                                    }
                                    ?>
                                        <div class="d-flex flex-row-reverse" id="use" style="visibility: hidden;font-size: 0.8em;">ผู้กำลังใช้งาน : </div>
                                    </div>
                                </div>
                                ...
                                <form action="<?= $url_form ?>" method="POST">
                                    <div class="card-body">
                                        ...
                                        <input  type="hidden" class="form-control" placeholder="ประเภท"  name="project_type_edit" id="project_type_edit"  value="<?php echo $project_type_edit; ?>">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            foreach ($sugges_query as $value_sugges) {
                                                                ...
                                                                if ($status_query != null) {
                                                                    ...
                                                                    } elseif ($status_name == "condition") {
                                                                        $text_status = "ติดเงื่อนไข";
                                                                        $style = 'background-color: #ff9c14';
                                                                    } else {
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div class="btn-group" id="myDropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                                                        ...
                                                                                        <button class="dropdown-item" type="button" onclick="change_status('<?= $subject_id ?>', '<?= $sugges_id ?>', '<?= $status_id ?>', 'condition')">ติดเงื่อนไข</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
...
//                                                                                ->where("FK_suggestion_id", $value_sugges["suggestion_id"])->get()->result_array();
                                                                        ...
                                                                        <?php
                                                                        $condition_query = $sugges->db->select("*")
                                                                            ->from("tbl_condition")
                                                                            ->where("FK_suggestion_id", $value_sugges["suggestion_id"])
                                                                            ->where("condition_status_del !=", "del")
                                                                            ->get()->result_array();

                                                                        //                                                                print_r($condition_query);
                                                                        foreach ($condition_query as $value_condition) {
                                                                            ?>
                                                                                <hr>
                                                                                <div class="row ">
                                                                                    <div class="col-12">
                                                                                        <div class="card">
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                <blockquote class="blockquote mb-0">
                                                                                                    <div style="font-size:1.2vw;"><?php echo $value_condition["condition_text"]; ?></div>
                                                                                                    <div style="display: none;" id="edit_anwser_text_<?php echo $value_condition["condition_text"]; ?>"> <?php echo $value_condition["condition_text"]; ?></div>
                                                                                                    <div class="row justify-content-end" style="color: gray">
...
//                                                                                        }
                                                                                                    ?>
                                                                                                    <?php
                                                                                                    if ($value_condition["condition_docnumber"] != "" || $value_condition["condition_docnumber"] != null) {
                                                                                                        echo 'เลขที่หนังสือหน่วยรับตรวจ &nbsp;:&nbsp;&nbsp;<div id=condition_docnumber_' . $value_condition["condition_docnumber"] . '">' . $value_condition["condition_docnumber"] . '</div>';
                                                                                                    }
                                                                                                    ?>
                                                                                                    &nbsp;&nbsp;<div style="">วันที่รับรายงานตอบกลับ : <?php echo convert_date($value_condition["condition_respone_date"]) ?></div>
                                                                                                </div>
                                                                                                <hr>

                                                                                                <div class="d-flex flex-row-reverse">
                                                                                                    <div class="p-2">
                                                                                                        <button type="button" style="color: black; margin-left:10px" class="open-modal_delete_condition btn btn-outline-secondary btn-sm float-right" data-toggle="modal" data-target="#delete_condition" data-id="<?= $value_condition["condition_id"] ?>" data-condition_text="<?= $value_condition["condition_text"] ?>" >
                                                                                                            <i class="fas fa-trash-alt" ></i> ลบเงื่อนไข
                                                                                                        </button>
                                                                                                    </div>
                                                                                                    <div class="p-2">
                                                                                                        <button  type="button" style="color: black;" class="open-modal_edit_condition btn btn-outline-secondary btn-sm float-right" data-toggle="modal" data-target="#edit_condition" data-id="<?= $value_condition["condition_id"] ?>" data-condition_text="<?= $value_condition["condition_text"] ?>" data-condition_subject_id="<?= $value_condition["FK_subject_id"] ?>" data-condition_suggestion_id="<?= $value_condition["FK_suggestion_id"] ?>" data-condition_doc_number="<?= $value_condition["condition_docnumber"] ?>" data-condition_respone_date="<?= $value_condition["condition_respone_date"] ?>">
                                                                                                            <i class="fas fa-edit" ></i> แก้ไขเงื่อนไข
                                                                                                        </button>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
...
//        });
        ...
        function change_status(subject_id, sugges_id, status_id, status) {
            if (status == "condition") {
                $("#add_condition").modal("show")
                $("#add_condition .modal-body #subject_id_condition").val(subject_id);
                $("#add_condition .modal-body #sugges_id_condition").val(sugges_id);
                $("#add_condition .modal-body #status_id_codition").val(status_id);
                $("#add_condition .modal-body #status_condition").val(status);
                
                
            
                $("#add_condition .modal-body #text_subject_con").html($("#subject_name_"+subject_id).html());
                $("#add_condition .modal-body #text_sugges_con").html($("#suggestion_name_"+sugges_id).html());
            } else {
                $.ajax({
        ...
        var quill_addcondition = new Quill('#editor_addcondition', {
            modules: {
                toolbar: toolbarOptions
            },
            theme: 'snow'
        });
        var quill_editcondition = new Quill('#editor_editcondition', {
            modules: {
                toolbar: toolbarOptions
            },
            theme: 'snow'
...
//            var data = $(this).data('data');
            ...
            if ($("#Select_station_edit").val() == "6" || $("#Select_center_edit").val() == "4") {
                $("#checkbox-large-no_sugges_edit").prop("checked", true);
            } else {
                $("#checkbox-large-no_sugges_edit").prop("checked", false);
            }
        });
        //เพิ่ม มติ
...
//            var name = $(this).data('data');
        ...
        $("#Select_station").on('change', function () {
            if (this.value == "6") {
                $("#checkbox-large-no_sugges").prop("checked", true);
            } else {
                $("#checkbox-large-no_sugges").prop("checked", false);
            }
        });
        $("#Select_station_edit").on('change', function () {
            if (this.value == "6") {
                $("#checkbox-large-no_sugges_edit").prop("checked", true);
            } else {
                $("#checkbox-large-no_sugges_edit").prop("checked", false);
        ...
        $("#Select_center_edit").on('change', function () {
            if (this.value == "4") {
                $("#checkbox-large-no_sugges_edit").prop("checked", true);
            } else {
                $("#checkbox-large-no_sugges_edit").prop("checked", false);
        ...
        function add() {
            ...
            var select_satation = $("#Select_station").val()


            var select_center_value = 0;
            var select_satation_value = 0;
            if ($("#check_o").is(":checked")) {
                var check_o = $("#check_o").val()
            } else {
                var check_o = "-"
            }

            if ($("#check_f").is(":checked")) {
            ...
            if ($("#check_c").is(":checked")) {
                var check_c = $("#check_c").val()
            } else {
                var check_c = "-"
            }

            if ($("#check_it").is(":checked")) {
                var check_it = $("#check_it").val()
            } else {
                var check_it = "-"
            }

            var allcheck = check_o + "," + check_f + "," + check_c + "," + check_it



            var no_suggess = 0;
            var no_suggess_check = $("input[type=checkbox][name=no_sugges]:checked").val()
            if (no_suggess_check == "no_sugges") {
                no_suggess = 1
            }


            console.log(select_center)

            if (select_satation == "undefined" || select_satation == "" || select_satation == null) {
                console.log("กลาง")
                if (select_center == 0) {
                    $("#Select_center").focus()
                    select_center_value = 0
                    $("#loader").css("display", "none");
                    return false;
                } else {
                    select_center_value = select_center
                }

            } else if (select_center == "undefined" || select_center == "" || select_center == null) {
                console.log("สถานี")
                if (select_satation == 0) {
                    $("#Select_station").focus()
                    $("#loader").css("display", "none");
                    return false;
                } else {
                    select_satation_value = select_satation
                }
            }
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "select_center": select_center_value,
                    "select_satation": select_satation_value,
                    "allcheck": allcheck,
                    "no_suggess": no_suggess
                },
                success: (function (result) {
...
//                    console.log(result);
                    window.location.replace("<?php echo base_url('Home/project_detail') ?>/" + obj.projid + "?per_page=" + obj.page)
...
//var $()
        ...
        function edit() {
            ...
            var select_center = $("#Select_center_edit").val()
            var select_satation = $("#Select_station_edit").val()

            var select_center_value = 0;
            var select_satation_value = 0;
            if ($("#check_o_edit").is(":checked")) {
                var check_o = $("#check_o").val()
            } else {
                var check_o = "-"
            }

            if ($("#check_f_edit").is(":checked")) {
                var check_f = $("#check_f").val()
            } else {
                var check_f = "-"
            }

            if ($("#check_c_edit").is(":checked")) {
                var check_c = $("#check_c").val()
            } else {
                var check_c = "-"
            }

            if ($("#check_it_edit").is(":checked")) {
                var check_it = $("#check_it").val()
            } else {
                var check_it = "-"
            }
            ...
            var no_suggess = 0;
            var no_suggess_check = $("input[type=checkbox][name=no_sugges_edit]:checked").val()
            if (no_suggess_check == "no_sugges") {
                no_suggess = 1
            }
            console.log(no_suggess)

            if (select_satation == "undefined" || select_satation == "" || select_satation == null) {
                console.log("กลาง")
                if (select_center == 0) {
                    $("#Select_center_edit").focus()
                    select_center_value = 0
                    $("#loader").css("display", "none");
                    return false;
                } else {
                ...
                console.log("สถานี")
                if (select_satation == 0) {
                    $("#Select_station_edit").focus()
                    select_station_value = 0
                    $("#loader").css("display", "none");
                    return false;
                } else {
                    select_satation_value = select_satation
...
//                    "suggestion_docnumber_edit": $("#suggestion_docnumber_edit").val()
    ...
    <script>
        ...
        }).datepicker("setDate", new Date("<?= $project_create_date ?>")); //กำหนดเป็นวันปัจุบัน
        ...
        $('#condition_respone_date').datepicker({
            format: 'dd/mm/yyyy',
            todayBtn: true,
            language: 'th', //เปลี่ยน label ต่างของ ปฏิทิน ให้เป็น ภาษาไทย   (ต้องใช้ไฟล์ bootstrap-datepicker.th.min.js นี้ด้วย)
            thaiyear: true //Set เป็นปี พ.ศ.
            ...
            $.ajax({
                ...
                success: (function (result) {
                    ...
                    if (obj.status > 0) {
                        ...
                        window.location.replace('<?php echo base_url('home/project_detail/') ?>/' + obj.page);
                    }
                }),
                error: function (xhr) {
                    console(xhr.statusText);
        ...
        function onkeyupdateproject() {
            $.ajax({
                ...
                data: {
                    ...
                    "project_type_edit": $("#project_type_edit").val(),
                },
                success: (function () {
...
<?php if ($_SESSION["insert_subject"] === 1) { ?>
                    const mapBtn = document.querySelector(".open-modal_addsugges");
                    mapBtn.click();
<?php } ?>
            $('#addsugges').on("hide.bs.modal", function () {
<?php $_SESSION["insert_subject"] = 0 ?>
            })
...
function convert_date_time($date)
{
    ...
    $mm = $date_ex2[1];
    $dd = $date_ex2[2];
    $textday = $dd . "/" . $mm . "/" . $yyyy . " " . substr($date_ex[1], 0, -3);
    ;
    return $textday;
}
?>
...
//    }, false);
    ...
    function add_condition() {
        var subject_id_condition = $("#subject_id_condition").val()
        var sugges_id_condition = $("#sugges_id_condition").val()
        var status_id_codition = $("#status_id_codition").val()
        var status_condition = $("#status_condition").val()
        var condition_docnumber = $("#condition_docnumber").val()
        var condition_respone_date = $("#condition_respone_date").val()
        
        var editor_quill_addcondition = quill_addcondition.root.innerHTML;
        if (quill_addcondition.getText().trim().length === 0) {
            quill_addcondition.focus();
            return false;
        } else {

            $.ajax({
                url: "<?php echo base_url() ?>Status/condition",
                type: "POST",
                datatype: "json",
                data: {
                    "subject_id_condition": subject_id_condition,
                    "sugges_id_condition": sugges_id_condition,
                    "status_id_codition": status_id_codition,
                    "status_condition": status_condition,
                    "condition_text": editor_quill_addcondition,
                    "condition_docnumber": condition_docnumber,
