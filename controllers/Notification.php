...
left JOIN  tbl_project
ON tbl_project.project_id  = tbl_subject.FK_project_id
WHERE " . $searchQuery . " $searchDate $group subject_status_delete !=  'del' and status_name = 'progress' or tbl_status.status_name = 'no' AND suggestion_duedate BETWEEN NOW() AND DATE_ADD(NOW(), INTERVAL '" . $day . "'DAY) AND suggestion_status_delete != 'del'";
