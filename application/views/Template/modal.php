...
<div class="modal fade" id="myModal_login" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button onclick="c()" type="button" class="btn btn-secondary" data-dismiss="modal">ปิด</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modalลบประเด็น -->
<div class="modal fade" id="deletesubject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
...
<!-- Modalลบมติ -->
<div class="modal fade " id="deletesugges" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<!-- Modalลบผลตอบ -->
<div class="modal fade" id="deleteanwser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="form-group form-group-default">
                        ...
                        <select class="form-control" id="Select_station" style="color: black;">
                            ...
                            <?php foreach ($type_station as $key => $value) { ?>
                                <option value="<?php echo $value["type_subject_value"] ?>">
                                    <?php echo $value["type_subject_name"] ?>
                                </option>
                            <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <div class="custom-control-lg custom-control custom-checkbox" style="top: 0.5rem;">
                            <input class="custom-control-input" id="checkbox-large-no_sugges" type="checkbox"
                                name="no_sugges" value="no_sugges" />
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="datepicker form-control" placeholder="วันที่ขยายเวลา"
                                data-date-format="mm/dd/yyyy" name="follow_date" id="follow_date"
...
<!-- Modal แก้การติดตาม -->
<div class="modal fade" id="edit_follow" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="usr">วันที่ขยายเวลา :</label>
                            <input type="text" class="datepicker form-control" placeholder="วันที่ขยายเวลา"
                                data-date-format="mm/dd/yyyy" name="edit_follow_date" id="edit_follow_date"
                                onkeypress="return false" autocomplete="off">
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                if (strpos($project_name, 'บริหารสถานี') != TRUE) {
                    ...
                    <div class="form-group form-group-default">
                        ...
                        <select class="form-control" id="Select_center_edit" style="color: black;">
                            <option value="0" <?php echo $selected0 ?>>-- โปรดเลือก ระดับความสำคัญของผลการตรวจสอบ --
                            </option>
                    ...
                    <div class="form-group form-group-default">
                        ...
                        <select class="form-control" id="Select_station_edit" style="color: black;">
                            ...
                            foreach ($type_station as $key => $value) {
                                ...
                                ?>
                                <option value="<?php echo $value["type_subject_value"] ?>" <?php echo $selected ?>>
                                    <?php echo $value["type_subject_name"] ?>
                                </option>
                            <?php } ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <div class="custom-control-lg custom-control custom-checkbox" style="top: 0.5rem;">
                            <input class="custom-control-input" id="checkbox-large-no_sugges_edit" type="checkbox"
                                name="no_sugges_edit" value="no_sugges" />
...
<div class="modal fade" id="addsugges" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="datepicker form-control" placeholder="วันที่"
                                data-date-format="mm/dd/yyyy" name="duedate" id="duedate" required=""
                                onkeypress="return false" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="custom-control-lg custom-control custom-checkbox" style="top: 0.5rem;">
                                <input class="custom-control-input" id="checkbox-large" type="checkbox"
                                    name="checkbox_sugges" onclick="checkbox('')" />
...
<div class="modal fade" id="editsugges" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="usr">วันที่แล้วเสร็จ :</label>
                            <input type="text" class="datepicker form-control" placeholder="วันที่เริ่มดำเนิการ"
                                data-date-format="mm/dd/yyyy" name="edit_duedate" id="edit_duedate"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="usr">ไม่สามารถกำหนดวันที่แล้วเสร็จได้ :</label>
                            <div class="custom-control-lg custom-control custom-checkbox" style="top: 0.5rem;">
                                <input class="custom-control-input" id="checkbox-large1" type="checkbox"
                                    name="checkbox_sugges_edit" onclick="checkbox('')" />
...
<div class="modal fade" id="add_anwser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="เลขที่หนังสือ"
                                                name="anwser_docnumber" id="anwser_docnumber" autocomplete="off">
                                            <div style="color: gray">* กรณีเลขที่หนังสือหน่วยรับตรวจมากกว่า 1
                                                ให้เว้นวรรค</div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="datepicker form-control"
                                                placeholder="วันที่รับรายงานตอบกลับ" data-date-format="mm/dd/yyyy"
                                                name="anwser_respone_date" id="anwser_respone_date"
                                                onkeypress="return false" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="edit_anwser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="container horizontal-scrollable">
                    <div class="row">
                        <div class="col-6 float-left">
                            <label for="usr" class="font-weight-bold">ประเด็น</label>
                            <div>
                                <p id="text_subject_edit" style=" width:100%;
                                     word-wrap: break-word;"></p>
                            </div>
                            <label for="usr" class="font-weight-bold">มติที่ประชุม</label>
                            <div>
                                <p id="text_sugges_edit" style=" width:100%;
                                     word-wrap: break-word;"></p>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="usr">เลขที่หนังสือตอบกลับ :</label>
                                            <input type="text" class="form-control" placeholder="เลขที่หนังสือ"
                                                name="anwser_docnumber_edit" id="anwser_docnumber_edit"
                                                autocomplete="off">
                                            <div style="color: gray">* กรณีเลขที่หนังสือหน่วยรับตรวจมากกว่า 1
                                                ให้เว้นวรรค</div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="datepicker form-control"
                                                placeholder="วันที่รับรายงานตอบกลับ" data-date-format="mm/dd/yyyy"
                                                name="anwser_respone_date_edit" id="anwser_respone_date_edit"
                                                onkeypress="return false" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
...
<!-- Modalลบการคติดตาม -->
<div class="modal fade" id="deletefollow" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- เพิ่มเงือนไข -->
<div class="modal fade" id="add_condition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="exampleModalLabel">เพิ่มเงื่อนไขผลการปฏิบัติตามข้อเสนอแนะ
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6 float-left">
                            <label for="usr" class="font-weight-bold">ประเด็น</label>
                            <div>
                                <p id="text_subject_con" style=" width:100%;
                                     word-wrap: break-word;"></p>
                            </div>
                            <label for="usr" class="font-weight-bold">มติที่ประชุม</label>
                            <div>
                                <p id="text_sugges_con" style=" width:100%;
                                     word-wrap: break-word;"></p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="usr" class="font-weight-bold">เงื่อนไข</label>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="usr">เลขที่หนังสือตอบกลับ :</label>
                                            <input type="text" class="form-control" placeholder="เลขที่หนังสือ"
                                                name="condition_docnumber" id="condition_docnumber" autocomplete="off">
                                            <div style="color: gray">* กรณีเลขที่หนังสือหน่วยรับตรวจมากกว่า 1
                                                ให้เว้นวรรค</div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="datepicker form-control"
                                                placeholder="วันที่รับรายงานตอบกลับ" data-date-format="mm/dd/yyyy"
                                                name="condition_respone_date" id="condition_respone_date"
                                                onkeypress="return false" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-xl" role="document" >
        <div class="modal-content" >
            ...
            <div class="modal-body">
                ...
                <input  id="condition_id" value="" type="hidden"/>                
...
<!-- แก้ไข เงือนไข -->
<div class="modal fade" id="edit_condition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6 float-left">
                            <label for="usr" class="font-weight-bold">ประเด็น</label>
                            <div>
                                <p id="text_subject_con_edit" style=" width:100%;
                                     word-wrap: break-word;"></p>
                            </div>
                            <label for="usr" class="font-weight-bold">มติที่ประชุม</label>
                            <div>
                                <p id="text_sugges_con_edit" style=" width:100%;
                                     word-wrap: break-word;"></p>
                            </div>
                        </div>
                        <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="usr">เลขที่หนังสือตอบกลับ :</label>
                                            <input type="text" class="form-control" placeholder="เลขที่หนังสือ"
                                                name="condition_docnumber_edit" id="condition_docnumber_edit"
                                                autocomplete="off">
                                            <div style="color: gray">* กรณีเลขที่หนังสือหน่วยรับตรวจมากกว่า 1
                                                ให้เว้นวรรค</div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="datepicker form-control"
                                                placeholder="วันที่รับรายงานตอบกลับ" data-date-format="mm/dd/yyyy"
                                                name="condition_respone_date_edit" id="condition_respone_date_edit"
                                                onkeypress="return false" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
...
<!-- Modalลบเงื่อนไข -->
<div class="modal fade" id="delete_condition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<script>
    ...
    $(".open-modal_edit_condition").click(function () {
        var id = $(this).data('id');
        var subject_id = $(this).data('condition_subject_id');
        var sugges_id = $(this).data('condition_suggestion_id');
        $("#edit_condition .modal-body #text_subject_con_edit").html($("#subject_name_" + subject_id).html());
        $("#edit_condition .modal-body #text_sugges_con_edit").html($("#suggestion_name_" + sugges_id).html());
        ...
        var condition_respone_date_edit = $(this).data('condition_respone_date');
        var condition_doc_number_edit = $(this).data('condition_doc_number');

        $("#condition_docnumber_edit").val(condition_doc_number_edit)
        $('#condition_respone_date_edit').datepicker({
            format: 'dd/mm/yyyy',
            todayBtn: true,
            language: 'th', //เปลี่ยน label ต่างของ ปฏิทิน ให้เป็น ภาษาไทย   (ต้องใช้ไฟล์ bootstrap-datepicker.th.min.js นี้ด้วย)
            thaiyear: true //Set เป็นปี พ.ศ.

        }).datepicker("setDate", new Date(condition_respone_date_edit)); //กำหนดเป็นวันปัจุบัน
        ...
        if (quill_editcondition.getText().trim().length === 0) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "condition_docnumber": $("#condition_docnumber_edit").val(),
                    "condition_respone_date": $('#condition_respone_date_edit').val()
                },
