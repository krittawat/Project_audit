...
## Search 
        ...
        if ($_POST['start_date'] != '' and $_POST['end_date'] != '') {
            $searchDate = "suggestion_duedate BETWEEN '" . $this->convert_date3($_POST['start_date']) . "' AND '" . $this->convert_date3($_POST['end_date']) . "' and";
        }
...
and (status_name = 'progress' or status_name = 'no')  AND suggestion_status_delete != 'del'";
...
and project_status_delete !=  'del'
and (status_name = 'progress' or tbl_status.status_name = 'no')  AND 
